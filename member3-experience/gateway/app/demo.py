    ...
    def get_current_state(self) -> Dict[str, Any]:
        ...
        step_definitions = {
            ...
            3: {
                ...
                "attention_mode": "SAFETY_FOCUS",
                "attention_reason": "Support vehicle within dynamic swing radius (12m < 15m threshold).",
                "summary": "Support utility vehicle approaches within 12m perimeter on blind counterweight side.",
                "seatbelt": True,
                "proximity_hazards": 1,
                "idle_pct": 10.2,
                "fuel_burn_rate_lph": 14.2,
